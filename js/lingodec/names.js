...
import { OpCode, ChunkExprType, PutType } from './enums.js';
import { Endianness } from './enums.js';

/**
 * StandardNames - Static lookup tables for opcode and property names
 */
export const StandardNames = {
    ...
    animationPropertyNames: {
        ...
        0x1a: "soundLevel",
        0x1b: "stageColor",
        // 0x1c indicates dontPassEvent was called. No Lingo-accessible name.
    ...
    getOpcodeName(id) {
        ...
        const name = this.opcodeNames[id];
        if (name === undefined) {
            return "unk" + id.toString(16).padStart(2, '0');
        }
        return name;
    },
...
/**
 * ScriptNames - Per-script name table
 */
